...
class App(QMainWindow):
    ...
    def initUI(self):
        ...
        self.label.setText("Ingrese la palabra a buscar: ")
        self.label.setStyleSheet("font-size: 13px; color: #A0184B;")

        # Create textbox
        self.textbox = QLineEdit(self)
        self.textbox.move(55, 50)
        self.textbox.resize(280,40)
        self.textbox.setStyleSheet("border: 1px solid #A0184B;")

        # Create a button in the window
        self.button = QPushButton('BUSCAR', self)
        self.button.move(60,115)
